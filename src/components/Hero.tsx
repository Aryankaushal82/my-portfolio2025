...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto flex flex-col justify-center">
      <div className={`absolute inset-0 sm:top-[120px] top-[120px] max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText}`}>{personalInfo.name}</h1>
          ...
          <div className="mt-4 flex gap-3">
            ...
            <a 
              ...
              className="p-2 bg-white rounded-full shadow-sm hover:shadow-md transition-all"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-gray-800">
